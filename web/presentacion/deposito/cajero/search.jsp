        ...
        <div class="container">
            <div class="row justify-content-center align-items-center minh-100">
                <div class="col-lg-">
                    ...
                    <input placeholer="Cedula / Numero de cuenta" id="searchTerm" type="text" onkeyup="doSearch()"/>
                    <table id="datos" class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="ControladorDeposito?accion=deposito&id=<%= per.getNum_cuenta()%>">
                                        <img src="https://img.icons8.com/dusk/50/000000/deposit.png"/>
                                    </a>
                                </td>
                            </tr>
                            <%}%>
